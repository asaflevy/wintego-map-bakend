...
let LoggingInterceptor = class LoggingInterceptor {
    constructor(logSrv, httpService) {
        this.logSrv = logSrv;
    ...
    intercept(context, call$) {
        ...
        if (req) {
            ...
            return call$.handle().pipe(operators_1.tap(() => __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield this.httpService.get(`https://ipapi.co/json/`).toPromise();
                const result1 = yield ipApi.location(() => {
...
LoggingInterceptor = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [logInterseptor_service_1.LogInterseptorService, common_1.HttpService])
], LoggingInterceptor);
