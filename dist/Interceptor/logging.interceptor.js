    ...
    intercept(context, call$) {
        ...
        if (req) {
            ...
            return call$.handle().pipe(operators_1.tap(() => __awaiter(this, void 0, void 0, function* () {
                ...
                this.logSrv.insert({ message: logInter, ip, fkLocation: locationDoc._id });
...
LoggingInterceptor = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [logger_Interseptor_service_1.LoggerInterceptorService, location_service_1.LocationService, common_1.HttpService])
], LoggingInterceptor);
