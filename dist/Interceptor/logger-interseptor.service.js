...
let LoggerInterceptorService = class LoggerInterceptorService {
    constructor(loggerModel) {
        this.loggerModel = loggerModel;
    }
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.loggerModel.find({}).populate('fkLocation').exec();
        });
    }
    insert(loggerInterceptor) {
        return __awaiter(this, void 0, void 0, function* () {
...
LoggerInterceptorService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_2.InjectModel('LogInterceptor')),
